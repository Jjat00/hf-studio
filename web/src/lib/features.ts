...
export const FEATURES: Feature[] = [
  ...
  { title: "Higgsfield Genjutsu", description: "One upload in. Endless new versions", href: "/video?tab=genjutsu", kind: "Video", badge: "NEW", icon: "swap", art: "/art/object-swap.webp" },
